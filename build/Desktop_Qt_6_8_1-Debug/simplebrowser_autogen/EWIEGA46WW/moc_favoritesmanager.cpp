...
static constexpr auto qt_meta_stringdata_ZN16FavoritesManagerE = QtMocHelpers::stringData(
    "FavoritesManager",
    "addFolder",
    "",
    "addFavorite",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16FavoritesManagerE[] = {
...
Q_CONSTINIT const QMetaObject FavoritesManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16FavoritesManagerE.offsetsAndSizes,
    qt_meta_data_ZN16FavoritesManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16FavoritesManagerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FavoritesManager, std::true_type>,
        // method 'addFolder'
...
void FavoritesManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addFavorite(); break;
        case 2: _t->deleteFavorite(); break;
        case 3: _t->editFavorite(); break;
        case 4: _t->saveFavorites(); break;
        default: ;
        }
    }
    (void)_a;
...
void *FavoritesManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16FavoritesManagerE.stringdata0))
