...
static constexpr auto qt_meta_stringdata_ZN14DownloadWidgetE = QtMocHelpers::stringData(
    "DownloadWidget",
    "removeClicked",
    "",
    "DownloadWidget*",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14DownloadWidgetE[] = {
...
Q_CONSTINIT const QMetaObject DownloadWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14DownloadWidgetE.offsetsAndSizes,
    qt_meta_data_ZN14DownloadWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14DownloadWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DownloadWidget, std::true_type>,
        // method 'removeClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<DownloadWidget *, std::false_type>,
        // method 'updateWidget'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
...
void DownloadWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->removeClicked((*reinterpret_cast< std::add_pointer_t<DownloadWidget*>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        ...
        case 0:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< DownloadWidget* >(); break;
            }
            break;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DownloadWidget::*)(DownloadWidget * );
            if (_q_method_type _q_method = &DownloadWidget::removeClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *DownloadWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14DownloadWidgetE.stringdata0))
